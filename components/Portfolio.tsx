...
const projects = [
  ...
  {
    title: 'Travel Blog',
    description: 'Responsive blog showcasing travel experiences and tips.',
  ...
  return (
    <section id="portfolio" className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-extrabold text-center text-primary mb-12">Our Portfolio</h2>
